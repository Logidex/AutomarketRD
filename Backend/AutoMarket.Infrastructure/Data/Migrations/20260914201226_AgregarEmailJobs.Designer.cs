...
namespace AutoMarket.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260914201226_AgregarEmailJobs")]
    partial class AgregarEmailJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoMarket.Core.Entities.AdSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("IntervaloRotacionSeg")
                        .HasColumnType("integer");

                    b.Property<int>("MaxAnunciosSimultaneos")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AutoMarket.Core.Entities.AdSlotAnuncio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("EstadoTransferencia")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ImagenOriginalUrl")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("ImagenRedimensionadaUrl")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("UrlCapturaTransferencia")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.HasKey("Id");

                    b.HasIndex("FechaRecordatorioEnviadoUtc")
                    ...
                    b.HasIndex("AdSlotId", "Estado")
                        .HasDatabaseName("IX_AdSlotsAnuncios_Slot_Estado");

                    b.HasIndex("Estado", "FechaFinUtc")
                        .HasDatabaseName("IX_AdSlotsAnuncios_Estado_FechaFin");

                    b.ToTable("AdSlotsAnuncios");
                });

            modelBuilder.Entity("AutoMarket.Core.Entities.AdSlotPrecio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("DescuentoProElitePorcentaje")
                        .HasPrecision(5, 2)
                    ...
                    b.HasIndex("AdSlotId", "DuracionDias")
                        .IsUnique()
                        .HasDatabaseName("IX_AdSlotsPrecios_Slot_Duracion");

                    b.ToTable("AdSlotsPrecios");
                });
            ...
            modelBuilder.Entity("AutoMarket.Core.Entities.AdSlotAnuncio", b =>
                {
                    b.HasOne("AutoMarket.Core.Entities.AdSlot", "AdSlot")
                        .WithMany("Anuncios")
