...
export default function Comparador() {
  ...
  const idsParam = searchParams.getAll("ids").map(Number).filter(Number.isFinite);
  ...
  const especificacionesDe = (v: VehiculoComparador): Especificaciones[] => [
    {
      etiqueta: "Precio",
    ...
    <div className="min-h-screen bg-[#0c101b] text-white">
      ...
      <section className="border-b border-white/10 bg-gradient-to-b from-[#11161f] to-[#0c101b]">
        <div className="mx-auto max-w-6xl px-6 py-10 sm:px-8">
          ...
          <form onSubmit={buscar} className="mt-8">
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => agregarDesdeBusqueda(a)}
